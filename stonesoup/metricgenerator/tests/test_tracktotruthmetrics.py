...
def test_siap(trial_manager, trial_truths, trial_tracks, trial_associations, measure_class):
    ...
    # Test num_truths_at_time
    for timestamp in timestamps:
        assert siap_generator.num_truths_at_time(trial_manager, timestamp) == 3

    # Test num_associated_truths_at_time
    assert siap_generator.num_associated_truths_at_time(trial_manager, timestamps[0]) == 2
    assert siap_generator.num_associated_truths_at_time(trial_manager, timestamps[1]) == 3
    assert siap_generator.num_associated_truths_at_time(trial_manager, timestamps[2]) == 3
    assert siap_generator.num_associated_truths_at_time(trial_manager, timestamps[3]) == 2
